...
contract DiversiFiBlue is Ownable, ERC20 {
	IUniswapV2Router02 public uniswapV2Router;
	address public immutable uniswapV2Pair;

	string private constant _name = "DiversiFi Blue";
	string private constant _symbol = "DVFB";
	...
	CustomTaxPeriod private _launch2 = CustomTaxPeriod('launch2',0,3600,3,5,3,10,8,15);
	CustomTaxPeriod private _launch3 = CustomTaxPeriod('launch3',0,82800,3,5,3,5,8,15);
	...
	CustomTaxPeriod private _diversifi2 = CustomTaxPeriod('diversifi2',0,3600,3,5,3,5,8,15);
	...
	constructor() public ERC20(_name, _symbol) {
		...
		dividendTokens.push(address(0xCC42724C6683B7E57334c4E856f4c9965ED682bD)); //MATIC
		dividendTokens.push(address(0x1CE0c2827e2eF14D5C4f29a091d735A204794041)); //AVAX
	...
	function setWallets(address newLiquidityWallet, address newMarketingWallet) external onlyOwner {
		...
		if(marketingWallet != newMarketingWallet) {
			require(newMarketingWallet != address(0), "Diversifi: The marketingWallet cannot be 0");
	...
	// Base fees
	function setBaseFeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setBaseFeesOnSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
	...
	//Launch2 Fees
	function setLaunch2FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy,uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setLaunch2FeesOnSell(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
	...
	//Launch3 Fees
	function setLaunch3FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setLaunch3FeesOnSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
	...
	function setDiversifiHour1BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
		_setCustomBuyTaxPeriod(_diversifi1, _liquidityFeeOnBuy, _marketingFeeOnBuy, _holdersFeeOnBuy);
		emit FeeChange('diversifi1Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _holdersFeeOnBuy);
	}
	function setDiversifiHour1SellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
		_setCustomSellTaxPeriod(_diversifi1, _liquidityFeeOnSell, _marketingFeeOnSell, _holdersFeeOnSell);
		emit FeeChange('diversifi1Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _holdersFeeOnSell);
	}
	// diversifi Hour 2 Fees
	function setDiversifiHour2BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
		_setCustomBuyTaxPeriod(_diversifi2, _liquidityFeeOnBuy, _marketingFeeOnBuy, _holdersFeeOnBuy);
		emit FeeChange('diversifi2Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _holdersFeeOnBuy);
	}
	function setDiversifiHour2SellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
		_setCustomSellTaxPeriod(_diversifi2, _liquidityFeeOnSell, _marketingFeeOnSell, _holdersFeeOnSell);
		emit FeeChange('diversifi2Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _holdersFeeOnSell);
	}
	...
	function getDiversifi1BuyFees() external view returns (uint256, uint256, uint256){
		return (_diversifi1.liquidityFeeOnBuy, _diversifi1.marketingFeeOnBuy, _diversifi1.holdersFeeOnBuy);
	}
	function getDiversifi1SellFees() external view returns (uint256, uint256, uint256){
		return (_diversifi1.liquidityFeeOnSell, _diversifi1.marketingFeeOnSell, _diversifi1.holdersFeeOnSell);
	}
	function getDiversifi2BuyFees() external view returns (uint256, uint256, uint256){
		return (_diversifi2.liquidityFeeOnBuy, _diversifi2.marketingFeeOnBuy, _diversifi2.holdersFeeOnBuy);
	}
	function getDiversifi2SellFees() external view returns (uint256, uint256, uint256){
		return (_diversifi2.liquidityFeeOnSell, _diversifi2.marketingFeeOnSell, _diversifi2.holdersFeeOnSell);
	}
	...
	function _setCustomSellTaxPeriod(CustomTaxPeriod storage map,
		...
		require(_liquidityFeeOnSell + _marketingFeeOnSell + _holdersFeeOnSell <= 30, "Diversifi: Sum of fees cannot exceed 30%");
	...
	function _setCustomBuyTaxPeriod(CustomTaxPeriod storage map,
		...
		require(_liquidityFeeOnBuy + _marketingFeeOnBuy + _holdersFeeOnBuy <= 30, "Diversifi: Sum of fees cannot exceed 30%");
